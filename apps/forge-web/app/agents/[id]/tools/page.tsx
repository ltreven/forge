...
export default function AgentToolsPage() {
  ...
  return (
    <div className="mx-auto max-w-2xl px-4 py-8 sm:px-6">
      <Link href={`/agents/${agentId}`} id="tools-back"
      ...
      <div className="mb-6">
        ...
        <p className="mt-1 text-sm text-muted-foreground">Connect MCP servers, APIs, and code execution capabilities.</p>
      </div>
      ...
      <div className="flex flex-col items-center gap-6 rounded-2xl border border-dashed border-border bg-muted/20 py-24 text-center">
        <div className="flex size-16 items-center justify-center rounded-2xl bg-amber-400/10 text-amber-600 dark:text-amber-400">
          <Wrench className="size-7" />
        </div>
        <div>
          <p className="text-base font-semibold text-foreground">Coming soon</p>
          <p className="mt-1.5 max-w-xs text-sm leading-relaxed text-muted-foreground">
            MCP tool integrations, external API connections, and sandboxed code execution will be configured here.
          </p>
        </div>

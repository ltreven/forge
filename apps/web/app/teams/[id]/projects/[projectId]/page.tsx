                ...
                <div key={statusVal} className="flex flex-col gap-3">
                  ...
                  <div className="flex flex-col gap-2">
                    {statusIssues.map(issue => (
                      <div 
                        key={issue.id} 
                        className="group relative flex flex-col gap-2 rounded-xl border border-border bg-card p-3 shadow-sm transition-all hover:border-primary/40 hover:shadow-md"
                      >

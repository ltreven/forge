export const en = {
  ...
  signup: {
    ...
    step3: {
      ...
      subtitle: "Select roles and name each agent. You can add more after setup.",
      roles: {
        engineer: {
  ...
  setup: {
    ...
    section3: {
      ...
      subtitle: "Connect GitHub so agents can clone, push, and open pull requests.",
      patLabel: "Personal Access Token (PAT)",
      patPlaceholder: "ghp_xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx",
      reposLabel: "Repository URLs",
